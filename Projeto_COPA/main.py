...
class Application(Imagens,Listas,Janela_1930):
    ...
    def gerar_widget(self,img,janela,nome,x,y,w,h):
        
        self.img_widget_uruguai_30 = base64.b64decode(img)
        self.bt_img_widget_1930 = PIL.Image.open(io.BytesIO(self.img_widget_uruguai_30))
        self.bt_img_widget_1930 = self.bt_img_widget_1930.resize((70, 86))
        self.bt_img_widget_1930 = ImageTk.PhotoImage(self.bt_img_widget_1930)

        self.botao_img1930 = customtkinter.CTkButton(
                                    self.frame_2_main,  
                                    image=self.bt_img_widget_1930,
                                    command=janela,
                                    text=nome.upper(), 
 ...
 # Botoes Label e Entry
    ...
    # 1930 - URUGUAI
        self.botao_img_Uruguai_1930 = self.gerar_widget(self.uruguai_1930,self.janela_1930,'copa de 1930\nUruguai',0.02,0.02,0.12,0.23)
           
    # 1934 - ITÁLIA
        self.botao_img_Italia_1934 = self.gerar_widget(self.italia_1934,self.janela_1930,'copa de 1934\nItália',0.16,0.02,0.12,0.23)
        
    # 1938 - FRANÇA
        self.botao_img_Franca_1938 = self.gerar_widget(self.franca_1938,self.janela_1930,'copa de 1938\nFrança',0.30,0.02,0.12,0.23)
        
    # 1950 - BRASIL
        self.botao_img_Brasil_1950 = self.gerar_widget(self.brasil_1950,self.janela_1930,'copa de 1950\nBrasil',0.44,0.02,0.12,0.23)    
       
    # 1954 - SUIÇA
        self.botao_img_Suica_1954 = self.gerar_widget(self.suica_1954,self.janela_1930,'copa de 1954\nSuiça',0.58,0.02,0.12,0.23)
        
    # 1958 - SUÉCIA
        self.botao_img_Suecia_1958 = self.gerar_widget(self.suecia_1958,self.janela_1930,'copa de 1958\nSuécia',0.72,0.02,0.12,0.23)
        
    # 1962 - CHILE
        self.botao_img_Chile_1962 = self.gerar_widget(self.chile_1962,self.janela_1930,'copa de 1962\nChile',0.86,0.02,0.12,0.23)
    
    # 1966 - INGLATERRA
        self.botao_img_Inglaterra_1966 = self.gerar_widget(self.inglaterra_1966,self.janela_1930,'copa de 1966\nInglaterra',0.02,0.26,0.12,0.23)
        
    # 1970 - MÈXICO
        self.botao_img_Mexico_1970 = self.gerar_widget(self.mexico_1970,self.janela_1930,'copa de 1970\nMéxico',0.16,0.26,0.12,0.23)
        
    # 1974 - ALEMANHA OCIDENTAL
        self.botao_img_Alemanha_O_1974 = self.gerar_widget(self.alemanha_O_1974,self.janela_1930,'copa de 1974\nAlemanha O',0.30,0.26,0.12,0.23)
        
    # 1978 - ARGENTINA
        self.botao_img_Argentina_1978 = self.gerar_widget(self.argentina_1978,self.janela_1930,'copa de 1978\nArgentina',0.44,0.26,0.12,0.23)
    
    # 1982 - ESPANHA
        self.botao_img_Espanha_1982 = self.gerar_widget(self.espanha_1982,self.janela_1930,'copa de 1982\nEspanha',0.58,0.26,0.12,0.23)
        
    # 1986 - MÉXICO
        self.botao_img_Mexico_1986 = self.gerar_widget(self.mexico_1986,self.janela_1930,'copa de 1986\nMéxico',0.72,0.26,0.12,0.23)
        
    # 1990 - ITÁLIA
        self.botao_img_Italia_1990 = self.gerar_widget(self.italia_1990,self.janela_1930,'copa de 1990\nItália',0.86,0.26,0.12,0.23)
        
    # 1994 - ESTADOS UNIDOS
        self.botao_img_USA_1994 = self.gerar_widget(self.usa_1994,self.janela_1930,'copa de 1994\nU.S.A',0.02,0.50,0.12,0.23)
        
    # 1998 - FRANÇA
        self.botao_img_Fraca_1998 = self.gerar_widget(self.franca_1998,self.janela_1930,'copa de 1998\nFrança',0.16,0.50,0.12,0.23)
        
    # 2002 - COREIA - JAPÃO
        self.botao_img_Coreia_japao_2002 = self.gerar_widget(self.coreia_japao_2002,self.janela_1930,'copa de 2002\nCoreia -Japão',0.30,0.50,0.12,0.23)
        
    # 2006 - ALEMANHA
        self.botao_img_Alemanha_2006 = self.gerar_widget(self.alemanha_2006,self.janela_1930,'copa de 2006\nAlemanha',0.44,0.50,0.12,0.23)
        
    # 2010 - AFRICA DO SUL
        self.botao_img_Africa_Sul_2010 = self.gerar_widget(self.africa_sul_2010,self.janela_1930,'copa de 2010\nAfrica do Sul',0.58,0.50,0.12,0.23)
        
    # 2014 - BRASIL
        self.botao_img_Brasil_2014 = self.gerar_widget(self.brasil_2014,self.janela_1930,'copa de 2014\nBrasil',0.72,0.50,0.12,0.23)
        
    # 2018 - RUSSIA
        self.botao_img_Russia_2018 = self.gerar_widget(self.russia_2018,self.janela_1930,'copa de 2018\nRussia',0.86,0.50,0.12,0.23)
        
    # 2022 - QATAR
        self.botao_img_Qatar_2022 = self.gerar_widget(self.qatar_2022,self.janela_1930,'copa de 2022\Qatar',0.02,0.74,0.12,0.23)
